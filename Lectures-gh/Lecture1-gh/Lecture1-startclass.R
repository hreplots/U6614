...
## -----------------------------------------------------------------------------
## create a Lecture2 and assign it to an R project
## -----------------------------------------------------------------------------

# confirm the working directory is correctly set
getwd()
...
##
##    d. inspect caste.fac, gender.fac, incsource.fac, education.fac, state.fac
