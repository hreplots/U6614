---
title: 'Lecture 3.2: Inference and Regression'
...
The results indicate a t-stat of `r round(t.test(gap_2007_asia$lifeExp, gap_2007_eur$lifeExp)$statistic, 2)` and associated p-value of close to 0, with a difference in mean life expectancy of almost 7 years that is statistically significant at the 1% level.
...
t.test(gap_2007_asia$lifeExp, 
       gap_2007_eur$lifeExp, 
       var.equal = FALSE)
```
...
gap_2007 %>% 
  ggplot(aes(x = log1p(gdpPercap), y = lifeExp)) +  #set aesthetic mappings
