...
### 4a) Use the filter function to subset observations belonging to the 'General' caste. {-}
- assign to new data frame, access_UPgen
- sort in descending order of monthly expenditure
- check if it worked

### 4b) Repeat part a, but this time, use the filter function to subset observations belonging to 'Reserved" castes: 'Other Backward Class', 'Scheduled Caste' or 'Scheduled Tribe', and assign them to a new data frame called 'access_UPres'. {-}
