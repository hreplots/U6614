---
title: 'DSPC 7514 Assignment 5: \break Water shutoffs, race, and income in Detroit: \break Community impact by race and income'
...
## Visualize and interpret the relationship between share Black and shutoffs per capita across census tracts in Detroit. Make sure to clearly label your plot axes.
...
## Visualize and interpret the relationship between median income and shutoffs per capita across census tracts in Detroit. Make sure to clearly label your plot axes.
...
## Visualize and interpret how shutoffs per capita relate to both Black share and median income on the ***same*** plot. Make sure to clearly label your plot axes and legend. Does race or income appear to be more salient? 
...
## Plot and interpret shutoffs per capita over time for tracts below/above citywide median housheold income (show two time series on a single plot). Make sure to clearly label your plot axes and legend.
...
## Plot and interpret shutoffs per capita over time for tracts that are at least 75% Black and those that aren't (show two time series on a single plot). Make sure to clearly label your plot axes and legend.
