...
### <span style="color: #FF00FF;"> For **Assignment 6**, please complete all of the questions from sections 1 through 4. We will review the remainder of the lesson, sections 5 through 7, during class. You may review those sections in advance of class, but only sections 1 through 4 will be graded. </span> {.unnumbered}
...
### <span style="color: #FF00FF;"> [*Assignment 6 ends here.*] </span> {.unnumbered}
...
The fact that the above plot seems to be consistent with parallel *pre-trends* is a good sign for the parallel trends assumption, the remaining question is whether anything else coinciding with the treatment period may have affected adopting states differently from non-adopting states.
